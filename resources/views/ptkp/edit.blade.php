...
<div class="mb-2 p-3 bg-body rounded shadow-sm">
    <form action='{{ url('ptkp/' .trim($data->ptkp)) }}' method='post'>
        ...
        <div class="mb-2 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='stt' value="{{ trim($data->stt) }}" id="stt"
                    maxlength="10">
            </div>
        </div>
        <div class="mb-2 row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" name='tanggungan' value="{{ trim($data->tanggungan) }}" id="tanggungan"
                    >
            </div>
        </div>
        <div class="mb-3 row">
